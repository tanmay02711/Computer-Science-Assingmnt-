...
std::cout<<array[0]<<std::endl<<array[n-1]<<std::endl;
return 0;
}
...
std::cout<< "smallest in given array is "<<minimum(array,n)<<std::endl;
std::cout<<""<<std::endl;
std::cout<<"Same Program by Binary search Algorithm Smallest and Largest"<<std::endl;
maxmin(array,n);
}
break;
...
{
int range;    
std::cout<<"Enter the Number of elements for series "<<std::endl;    
std::cin>>range;
fibo(range); 
}
 break;
